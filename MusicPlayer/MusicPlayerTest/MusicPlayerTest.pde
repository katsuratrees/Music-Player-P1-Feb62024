...
PImage mountain, darklights, forest, bike;
...
void setup() {
  ...
  //Variable Population
  //Images
  String mountain = "360_F_61235970_qV2bdaxGx3rM0kvi6bZkJYPmPP6RVpJB";
  String darklights = "ltotbngnzzu-uai-1600x900";
  String forest = "hallerbos-forest-halle-belgium-2-BEAUTFORESTS0721-4ff5b556613e4814b5b7165f8851de39";
  //String bike = "bike";
  //String extensionPNG  = ".png";
  String extensionJPG = ".jpg";
  String pathway = "../Images/";
  pathLightBackgroundImage = pathway + mountain + extensionJPG;
  pathDarkBackgroundImage = pathway + darklights + extensionJPG;
  String albumCoverImagePath = pathway + forest + extensionJPG;
